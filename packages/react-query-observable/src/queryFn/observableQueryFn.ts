...
export const queryFnFromObservableFn =
  <T = unknown, TQueryKey extends QueryKey = QueryKey, TObservable extends Observable<T> = Observable<T>>(
    observableFn: ObservableQueryFunction<T, TQueryKey, TObservable>,
  ...
  async (context) => {
    ...
    return new Promise<T>((resolve, reject) => {
      ...
      queriesSubscriptions.set(queryKeyHash, subscription)
    })
  }
